...
import icon from "../../common/components/_atoms/Icon/Filter 24px.png";
...
const Product = () => {
  ...
  return (
    <div className="flex flex-col gap-[50px]">
      <Breadcrumbs />
      <div className="flex flex-col px-[200px] gap-[20px]">
        <div className="flex justify-between">
          <Button
            className={"bg-[#00B207] flex items-center justify-between w-[131px] h-[45px] rounded-[43px] text-white px-[32px] py-[14px]"}
            children={"Filter"}
